...
3. DG-Lab COYOTE 3.0を利用する場合は、「デバイス接続」の隣にある「Coyote接続」を押す
4. 動画や音声とスクリプトを読み込んで再生
...
- U.F.O. TW用CSV
- タイムローター用CSV
- CoyoteScript（COYOTEを動かすためのスクリプト。[仕様はこちらを参照](https://scry1-csv.github.io/WebSexToysPlayer-Pages/coyotescript.html)）

CoyoteScriptは、[Scry1ScriptTools](https://github.com/scry1-csv/Scry1ScriptTools/releases/tag/v0.1) の `SexToyScriptConverter` によって、funscriptまたはUFOSA/A10サイクロンSA用CSVから変換することができます。
...
## 対応デバイス
- U.F.O. SA
- [U.F.O. TW](https://www.vorze.jp/ufotw/)
- [the Handy](https://www.thehandy.com/)
